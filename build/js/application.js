...
return n||r.editing||(o={tabIndex:"0",onFocus:r.handleReceivingFocus}),p.default.createElement("div",c({className:a.join(" ")},o),r.renderEditor())},u=n,o(r,u)}return u(t,e),d(t,[{key:"editing",get:function(){return this.props.forceEditMode||this.state.editing}}]),t}(p.default.Component),i.displayName="Editable",i.defaultProps={className:"",forceEditMode:!1,max:void 0,min:void 0,onChange:v.default,onEditStart:v.default,onEditEnd:v.default,placeholder:"",readonly:!1,step:1,type:void 0,value:""},l)
...
var o=n(2),u=n(6),i=n(19),l=n(5),c=r(l),s=n(20),d=r(s),f=n(15),p=r(f),m=n(22),y=r(m),h=n(8),v=r(h),b=n(16),g=r(b),E=n(23),_=r(E),O=n(24),j=r(O),w=n(17),P=r(w),x=t.PRIMARY_ATTRIBUTES=["acuity","agility","confidence","devotion","fitness","focus","intellect","intuition","strength"],C=(t.SECONDARY_ATTRIBUTES=["size","naturalArmor"],t.DERIVED_ATTRIBUTES=["body","mind","spirit","potency","reflex","resilience","accuracy","might","toughness","speed","damageThresholdLight","damageThresholdDeep","damageThresholdDeath","power"],t.DEFAULT_DESCRIPTORS=["age","concept","eyes","gender","hair","height","homeland","race","weight"]),N=function(e){return e.replace(/^./,e.charAt(0).toUpperCase())},A=x.map(function(e){return{id:e,computed:!1,name:N(e),value:-1}}),M=C.map(function(e){return{id:e,name:N(e),value:""}}),T=o.types.model("Character",{id:u.autoHash,name:"Unnamed Character",rp:0,xp:0,portraitURL:"",primaryAttributes:o.types.optional(o.types.array(d.default),A),descriptors:o.types.optional(o.types.array(y.default),M),equipment:o.types.optional(o.types.array(o.types.union(p.default,v.default,P.default)),[]),health:o.types.optional(g.default,{}),skills:o.types.optional(o.types.array(_.default),[]),traits:o.types.optional(o.types.array(j.default),[])}).views(function(e){var t=function(t){return(e.attribute(t)||{}).value||0},n=function(){for(var e=arguments.length,n=Array(e),r=0;r<e;r++)n[r]=arguments[r]
...
var a=n(12),o=r(a),u=n(25),i=r(u)
t.Character=o.default,t.Sheet=i.default},function(e,t,n){"use strict"
function r(e){if(Array.isArray(e)){for(var t=0,n=Array(e.length);t<e.length;t++)n[t]=e[t]
...
function r(e){return e&&e.__esModule?e:{default:e}}function a(e){if(Array.isArray(e)){for(var t=0,n=Array(e.length);t<e.length;t++)n[t]=e[t]
return n}return Array.from(e)}Object.defineProperty(t,"__esModule",{value:!0})
var o=n(2),u=n(6),i=n(14),l=r(i),c=n(7),s=r(c),d=function(e,t){var n=arguments.length>2&&void 0!==arguments[2]?arguments[2]:e
...
r.enumerable=r.enumerable||!1,r.configurable=!0,"value"in r&&(r.writable=!0),Object.defineProperty(e,r.key,r)}}return function(t,n,r){return n&&e(t.prototype,n),r&&e(t,r),t}}(),d=n(0),f=r(d),p=n(1),m=n(2),y=n(5),h=r(y),v=n(3),b=r(v),g=n(12),E=r(g),_=n(26),O=r(_),j=n(31),w=r(j),P=n(4),x=r(P),C=n(35),N=r(C),A=n(46),M=r(A),T=n(48),S=r(T),R=n(50),k=r(R),q=n(54),D=r(q)
n(58),n(59)
...
return f.default.createElement("div",{className:o,ref:n.bindContainer},f.default.createElement("header",null,f.default.createElement(x.default,{className:"character-name",value:e.name,onChange:e.setName}),f.default.createElement("div",{className:"xp attribute"},f.default.createElement("span",{className:"name"},"XP"),f.default.createElement(x.default,{min:0,value:e.xp,onChange:e.setXP})),f.default.createElement("div",{className:"rp attribute"},f.default.createElement("span",{className:"name"},"RP"),f.default.createElement(x.default,{min:0,max:5,value:e.rp,onChange:e.setRP})),f.default.createElement("div",{className:"power attribute"},f.default.createElement("div",{className:"name"},"CP"),f.default.createElement(x.default,{value:e.power,readonly:!0}))),f.default.createElement(S.default,{url:e.portraitURL,onChange:e.setPortraitURL}),f.default.createElement(M.default,{health:e.health}),f.default.createElement(w.default,{descriptors:e.descriptors}),f.default.createElement(O.default,{attributes:e.attributes,modifiers:e.modifiers}),f.default.createElement(D.default,{traits:e.traits,modifiers:e.modifiers,addTrait:e.addTrait,layout:a}),f.default.createElement(k.default,{skills:e.skills,modifiers:e.modifiers,addSkill:e.addSkill}),f.default.createElement(N.default,{buttons:f.default.createElement("div",{className:"buttons"},"Add:",f.default.createElement("button",{className:"icon-weapon",onClick:e.addWeapon}),f.default.createElement("button",{className:"icon-armor",onClick:e.addArmor}),f.default.createElement("button",{className:"icon-add",onClick:e.addItem})),equipment:e.equipment,layout:a}))},n.character=E.default.create(e.character),n.disposeOfSnapshotListener=(0,m.onSnapshot)(n.character,n.props.onChange),window.addEventListener("resize",n.handleWindowResize),n}return u(t,e),s(t,[{key:"componentDidMount",value:function(){this.handleWindowResize()}},{key:"componentWillUnmount",value:function(){this.disposeOfSnapshotListener()}}]),t}(d.Component),l.displayName="Sheet",l.defaultProps={character:{},onChange:b.default,readonly:!1},i=c))||i
t.default=V},function(e,t,n){"use strict"
function r(e){return e&&e.__esModule?e:{default:e}}function a(e,t){if(!(e instanceof t))throw new TypeError("Cannot call a class as a function")}function o(e,t){if(!e)throw new ReferenceError("this hasn't been initialised - super() hasn't been called")
return!t||"object"!=typeof t&&"function"!=typeof t?e:t}function u(e,t){if("function"!=typeof t&&null!==t)throw new TypeError("Super expression must either be null or a function, not "+typeof t)
e.prototype=Object.create(t&&t.prototype,{constructor:{value:e,enumerable:!1,writable:!0,configurable:!0}}),t&&(Object.setPrototypeOf?Object.setPrototypeOf(e,t):e.__proto__=t)}Object.defineProperty(t,"__esModule",{value:!0}),t.default=void 0
var i=n(0),l=r(i),c=n(27),s=r(c)
n(30)
...
var a=n(0),o=r(a),u=n(1),i=n(32),l=r(i)
n(34)
...
function r(e){return e&&e.__esModule?e:{default:e}}Object.defineProperty(t,"__esModule",{value:!0})
var a=n(0),o=r(a),u=n(1),i=n(9),l=r(i),c=n(36),s=r(c),d=n(15),f=r(d),p=n(41),m=r(p),y=n(43),h=r(y),v=n(17),b=r(v)
n(45)
...
return!t||"object"!=typeof t&&"function"!=typeof t?e:t}function u(e,t){if("function"!=typeof t&&null!==t)throw new TypeError("Super expression must either be null or a function, not "+typeof t)
e.prototype=Object.create(t&&t.prototype,{constructor:{value:e,enumerable:!1,writable:!0,configurable:!0}}),t&&(Object.setPrototypeOf?Object.setPrototypeOf(e,t):e.__proto__=t)}Object.defineProperty(t,"__esModule",{value:!0}),t.default=void 0
var i,l=n(0),c=r(l),s=n(1),d=n(16),f=n(13),p=r(f)
n(47)
var m=(0,s.observer)(i=function(e){function t(){var e,n,r,u
a(this,t)
...
return!t||"object"!=typeof t&&"function"!=typeof t?e:t}function u(e,t){if("function"!=typeof t&&null!==t)throw new TypeError("Super expression must either be null or a function, not "+typeof t)
e.prototype=Object.create(t&&t.prototype,{constructor:{value:e,enumerable:!1,writable:!0,configurable:!0}}),t&&(Object.setPrototypeOf?Object.setPrototypeOf(e,t):e.__proto__=t)}Object.defineProperty(t,"__esModule",{value:!0}),t.default=void 0
var i,l=n(0),c=r(l),s=n(1),d=n(9),f=r(d),p=n(51),m=r(p)
n(53)
...
function r(e){return e&&e.__esModule?e:{default:e}}Object.defineProperty(t,"__esModule",{value:!0})
var a=n(0),o=r(a),u=n(1),i=n(9),l=r(i),c=n(3),s=r(c),d=n(55),f=r(d)
n(57)
...
var Article = (0, _mobxReact.observer)(_class = function (_Component) {
  ...
  function Article() {
    ...
    return _ret = (_temp = (_this = (0, _possibleConstructorReturn3.default)(this, (_ref2 = Article.__proto__ || (0, _getPrototypeOf2.default)(Article)).call.apply(_ref2, [this].concat(args))), _this), _this.state = { activeTabId: 'sheet' }, _this.handleAddSheet = function () {
      _this.props.page.data.createCharacterData();
      _this.setState({ activeTabId: 'sheet' });
      ...
      return {
        ...
        contents: _react2.default.createElement(
          _react.Fragment,
          null,
          _react2.default.createElement(_reactJsxParser2.default, { components: { a: JsxLink }, jsx: html }),
      ...
      return _react2.default.createElement(
        ...
        (!viewport.isSmall || activeTabId === 'sheet') && _this.saveButton(),
    ...
    value: function render() {
      ...
      return _react2.default.createElement(
        ...
        _react2.default.createElement(
          ...
          !page.readonly && _react2.default.createElement(_Favorite2.default, { value: page.isFavorite, onToggle: page.toggleFavorite })
        ),
        _react2.default.createElement(
          'div',
          { className: 'contents' },
...
var o=Object.assign||function(t){for(var e=1;e<arguments.length;e++){var s=arguments[e]
for(var i in s)Object.prototype.hasOwnProperty.call(s,i)&&(t[i]=s[i])}return t},h=function(){function t(t,e){var s=[],i=!0,r=!1,n=void 0
...
throw new TypeError("Invalid attempt to destructure non-iterable instance")}}(),p=function(){function t(t,e){for(var s=0;s<e.length;s++){var i=e[s]
i.enumerable=i.enumerable||!1,i.configurable=!0,"value"in i&&(i.writable=!0),Object.defineProperty(t,i.key,i)}}return function(e,s,i){return s&&t(e.prototype,s),i&&t(e,i),e}}(),c=s(1),u=s(5),l=i(u),d=s(6),f=i(d),m=s(8),x=s(9),y=i(x),v=s(10),g={plugins:{jsx:!0}},b=function(t){function e(t){r(this,e)
var s=n(this,(e.__proto__||Object.getPrototypeOf(e)).call(this,t))
return k.call(s),s.handleNewProps(t),s}return a(e,t),p(e,[{key:"componentWillReceiveProps",value:function(t){this.handleNewProps(t)}}]),e}(u.Component)
b.displayName="JsxParser"
var k=function(){var t=this
...
var s=(e.jsx||"").trim().replace(/<!DOCTYPE([^>]*)>/g,"").replace(/(\r|\n)/g,"")
t.ParsedChildren=t.parseJSX(s)},this.parseJSX=function(e){var s="<root>"+e+"</root>",i=[]
try{i=new c.Parser(g,s).parse(),i=i.body[0].expression.children||[]}catch(e){return t.props.showWarnings&&console.warn(e),t.props.onError&&t.props.onError(e),[]}return i.map(t.parseExpression).filter(Boolean)},this.parseExpression=function(e){switch(e.type){case"JSXElement":return t.parseElement(e)
case"JSXText":return l.default.createElement(u.Fragment,null,e.value||"")
...
default:return}},this.parseElement=function(e){var s=t.props,i=s.bindings,r=void 0===i?{}:i,n=s.components,a=void 0===n?{}:n,p=e.children,c=void 0===p?[]:p,u=e.openingElement,d=u.attributes,x=void 0===d?[]:d,g=u.name
g=void 0===g?{}:g
var b=g.name
if(/^(html|head|body)$/i.test(b))return c.map(function(e){return t.parseElement(e)})
if(-1===t.blacklistedTags.indexOf(b.trim().toLowerCase())){var k=void 0
if(a[b]||(0,v.canHaveChildren)(b))if(k=c.map(t.parseExpression),a[b]||(0,v.canHaveWhitespace)(b)||(k=k.filter(function(t){return"string"!=typeof t||!/^\s*$/.test(t)})),0===k.length)k=void 0
else if(1===k.length){var E=k,w=h(E,1)
k=w[0]}var A=o({key:(0,m.randomHash)()},r)
return x.forEach(function(e){var s=e.name.name,i=y.default[s]||s,r=t.parseExpression(e)
0===t.blacklistedAttrs.filter(function(t){return t.test(i)}).length&&(A[i]=r)}),"string"==typeof A.style&&(A.style=(0,f.default)(A.style)),l.default.createElement(a[b]||b,A,k)}},this.render=function(){return t.props.renderInWrapper?l.default.createElement("div",{className:"jsx-parser"},t.ParsedChildren):l.default.createElement(u.Fragment,null,t.ParsedChildren)}}
e.default=b,b.defaultProps={bindings:{},blacklistedAttrs:[/^on.+/i],blacklistedTags:["script"],components:[],jsx:"",onError:function(){},showWarnings:!1,renderInWrapper:!0}},function(t,e,s){"use strict"
...
if((s+=e[i+1])>=t)return!0}}function r(t,e){return t<65?36===t:t<91||(t<97?95===t:t<123||(t<=65535?t>=170&&T.test(String.fromCharCode(t)):!1!==e&&i(t,L)))}function n(t,e){return t<48?36===t:t<58||!(t<65)&&(t<91||(t<97?95===t:t<123||(t<=65535?t>=170&&N.test(String.fromCharCode(t)):!1!==e&&(i(t,L)||i(t,P)))))}function a(t,e){return new j(t,{beforeExpr:!0,binop:e})}function o(t,e){return void 0===e&&(e={}),e.keyword=t,O[t]=new j(t,e)}function h(t){return 10===t||13===t||8232===t||8233===t}function p(t,e){return X.call(t,e)}function c(t,e){for(var s=1,i=0;;){M.lastIndex=i
var r=M.exec(t)
...
t+=s[0].length}},Y.eat=function(t){return this.type===t&&(this.next(),!0)},Y.isContextual=function(t){return this.type===V.name&&this.value===t&&!this.containsEsc},Y.eatContextual=function(t){return!!this.isContextual(t)&&(this.next(),!0)},Y.expectContextual=function(t){this.eatContextual(t)||this.unexpected()},Y.canInsertSemicolon=function(){return this.type===V.eof||this.type===V.braceR||F.test(this.input.slice(this.lastTokEnd,this.start))},Y.insertSemicolon=function(){if(this.canInsertSemicolon())return this.options.onInsertedSemicolon&&this.options.onInsertedSemicolon(this.lastTokEnd,this.lastTokEndLoc),!0},Y.semicolon=function(){this.eat(V.semi)||this.insertSemicolon()||this.unexpected()},Y.afterTrailingComma=function(t,e){if(this.type==t)return this.options.onTrailingComma&&this.options.onTrailingComma(this.lastTokStart,this.lastTokStartLoc),e||this.next(),!0},Y.expect=function(t){this.eat(t)||this.unexpected()},Y.unexpected=function(t){this.raise(null!=t?t:this.start,"Unexpected token")},Y.checkPatternErrors=function(t,e){if(t){t.trailingComma>-1&&this.raiseRecoverable(t.trailingComma,"Comma is not permitted after the rest element")
...
for(t.body||(t.body=[]);this.type!==V.eof;){var i=e.parseStatement(!0,!0,s)
...
switch(this.isLet()&&(r=V._var,i="let"),r){case V._break:case V._continue:return this.parseBreakContinueStatement(n,r.keyword)
case V._debugger:return this.parseDebuggerStatement(n)
case V._do:return this.parseDoStatement(n)
case V._for:return this.parseForStatement(n)
case V._function:return!t&&this.options.ecmaVersion>=6&&this.unexpected(),this.parseFunctionStatement(n,!1)
case V._class:return t||this.unexpected(),this.parseClass(n,!0)
case V._if:return this.parseIfStatement(n)
case V._return:return this.parseReturnStatement(n)
case V._switch:return this.parseSwitchStatement(n)
case V._throw:return this.parseThrowStatement(n)
case V._try:return this.parseTryStatement(n)
case V._const:case V._var:return i=i||this.value,t||"var"==i||this.unexpected(),this.parseVarStatement(n,i)
case V._while:return this.parseWhileStatement(n)
case V._with:return this.parseWithStatement(n)
case V.braceL:return this.parseBlock()
case V.semi:return this.parseEmptyStatement(n)
case V._export:case V._import:return this.options.allowImportExportEverywhere||(e||this.raise(this.start,"'import' and 'export' may only appear at the top level"),this.inModule||this.raise(this.start,"'import' and 'export' may appear only with 'sourceType: module'")),r===V._import?this.parseImport(n):this.parseExport(n,s)
...
return r===V.name&&"Identifier"===o.type&&this.eat(V.colon)?this.parseLabeledStatement(n,a,o):this.parseExpressionStatement(n,o)}},Z.parseBreakContinueStatement=function(t,e){var s=this,i="break"==e
...
if(t.label&&i)break}}return r===this.labels.length&&this.raise(t.start,"Unsyntactic "+e),this.finishNode(t,i?"BreakStatement":"ContinueStatement")},Z.parseDebuggerStatement=function(t){return this.next(),this.semicolon(),this.finishNode(t,"DebuggerStatement")},Z.parseDoStatement=function(t){return this.next(),this.labels.push(K),t.body=this.parseStatement(!1),this.labels.pop(),this.expect(V._while),t.test=this.parseParenExpression(),this.options.ecmaVersion>=6?this.eat(V.semi):this.semicolon(),this.finishNode(t,"DoWhileStatement")},Z.parseForStatement=function(t){if(this.next(),this.labels.push(K),this.enterLexicalScope(),this.expect(V.parenL),this.type===V.semi)return this.parseFor(t,null)
var e=this.isLet()
if(this.type===V._var||this.type===V._const||e){var s=this.startNode(),i=e?"let":this.value
return this.next(),this.parseVar(s,!0,i),this.finishNode(s,"VariableDeclaration"),!(this.type===V._in||this.options.ecmaVersion>=6&&this.isContextual("of"))||1!==s.declarations.length||"var"!==i&&s.declarations[0].init?this.parseFor(t,s):this.parseForIn(t,s)}var r=new f,n=this.parseExpression(!0,r)
return this.type===V._in||this.options.ecmaVersion>=6&&this.isContextual("of")?(this.toAssignable(n,!1,r),this.checkLVal(n),this.parseForIn(t,n)):(this.checkExpressionErrors(r,!0),this.parseFor(t,n))},Z.parseFunctionStatement=function(t,e){return this.next(),this.parseFunction(t,!0,!1,e)},Z.parseIfStatement=function(t){return this.next(),t.test=this.parseParenExpression(),t.consequent=this.parseStatement(!this.strict&&this.type==V._function),t.alternate=this.eat(V._else)?this.parseStatement(!this.strict&&this.type==V._function):null,this.finishNode(t,"IfStatement")},Z.parseReturnStatement=function(t){return this.inFunction||this.options.allowReturnOutsideFunction||this.raise(this.start,"'return' outside of function"),this.next(),this.eat(V.semi)||this.insertSemicolon()?t.argument=null:(t.argument=this.parseExpression(),this.semicolon()),this.finishNode(t,"ReturnStatement")},Z.parseSwitchStatement=function(t){var e=this
this.next(),t.discriminant=this.parseParenExpression(),t.cases=[],this.expect(V.braceL),this.labels.push(tt),this.enterLexicalScope()
for(var s,i=!1;this.type!=V.braceR;)if(e.type===V._case||e.type===V._default){var r=e.type===V._case
s&&e.finishNode(s,"SwitchCase"),t.cases.push(s=e.startNode()),s.consequent=[],e.next(),r?s.test=e.parseExpression():(i&&e.raiseRecoverable(e.lastTokStart,"Multiple default clauses"),i=!0,s.test=null),e.expect(V.colon)}else s||e.unexpected(),s.consequent.push(e.parseStatement(!0))
...
var et=[]
Z.parseTryStatement=function(t){if(this.next(),t.block=this.parseBlock(),t.handler=null,this.type===V._catch){var e=this.startNode()
this.next(),this.expect(V.parenL),e.param=this.parseBindingAtom(),this.enterLexicalScope(),this.checkLVal(e.param,"let"),this.expect(V.parenR),e.body=this.parseBlock(!1),this.exitLexicalScope(),t.handler=this.finishNode(e,"CatchClause")}return t.finalizer=this.eat(V._finally)?this.parseBlock():null,t.handler||t.finalizer||this.raise(t.start,"Missing catch or finally clause"),this.finishNode(t,"TryStatement")},Z.parseVarStatement=function(t,e){return this.next(),this.parseVar(t,!1,e),this.semicolon(),this.finishNode(t,"VariableDeclaration")},Z.parseWhileStatement=function(t){return this.next(),t.test=this.parseParenExpression(),this.labels.push(K),t.body=this.parseStatement(!1),this.labels.pop(),this.finishNode(t,"WhileStatement")},Z.parseWithStatement=function(t){return this.strict&&this.raise(this.start,"'with' in strict mode"),this.next(),t.object=this.parseParenExpression(),t.body=this.parseStatement(!1),this.finishNode(t,"WithStatement")},Z.parseEmptyStatement=function(t){return this.next(),this.finishNode(t,"EmptyStatement")},Z.parseLabeledStatement=function(t,e,s){for(var i=this,r=0,n=i.labels;r<n.length;r+=1){n[r].name===e&&i.raise(s.start,"Label '"+e+"' is already declared")}for(var a=this.type.isLoop?"loop":this.type===V._switch?"switch":null,o=this.labels.length-1;o>=0;o--){var h=i.labels[o]
...
else{if(t.declaration=null,t.specifiers=this.parseExportSpecifiers(e),this.eatContextual("from"))this.type!==V.string&&this.unexpected(),t.source=this.parseExprAtom()
...
for(this.expect(V.braceL);!this.eat(V.braceR);){if(i)i=!1
else if(e.expect(V.comma),e.afterTrailingComma(V.braceR))break
var r=e.startNode()
r.local=e.parseIdent(!0),r.exported=e.eatContextual("as")?e.parseIdent(!0):r.local,e.checkExport(t,r.exported.name,r.exported.start),s.push(e.finishNode(r,"ExportSpecifier"))}return s},Z.parseImport=function(t){return this.next(),this.type===V.string?(t.specifiers=et,t.source=this.parseExprAtom()):(t.specifiers=this.parseImportSpecifiers(),this.expectContextual("from"),t.source=this.type===V.string?this.parseExprAtom():this.unexpected()),this.semicolon(),this.finishNode(t,"ImportDeclaration")},Z.parseImportSpecifiers=function(){var t=this,e=[],s=!0
if(this.type===V.name){var i=this.startNode()
if(i.local=this.parseIdent(),this.checkLVal(i.local,"let"),e.push(this.finishNode(i,"ImportDefaultSpecifier")),!this.eat(V.comma))return e}if(this.type===V.star){var r=this.startNode()
return this.next(),this.expectContextual("as"),r.local=this.parseIdent(),this.checkLVal(r.local,"let"),e.push(this.finishNode(r,"ImportNamespaceSpecifier")),e}for(this.expect(V.braceL);!this.eat(V.braceR);){if(s)s=!1
else if(t.expect(V.comma),t.afterTrailingComma(V.braceR))break
var n=t.startNode()
...
return this.next(),6===this.options.ecmaVersion&&this.type!==V.name&&this.unexpected(),t.argument=this.parseBindingAtom(),this.finishNode(t,"RestElement")},st.parseBindingAtom=function(){if(this.options.ecmaVersion>=6)switch(this.type){case V.bracketL:var t=this.startNode()
return this.next(),t.elements=this.parseBindingList(V.bracketR,!0,!0),this.finishNode(t,"ArrayPattern")
case V.braceL:return this.parseObj(!0)}return this.parseIdent()},st.parseBindingList=function(t,e,s){for(var i=this,r=[],n=!0;!this.eat(t);)if(n?n=!1:i.expect(V.comma),e&&i.type===V.comma)r.push(null)
else{if(s&&i.afterTrailingComma(t))break
if(i.type===V.ellipsis){var a=i.parseRestBinding()
i.parseBindingListItem(a),r.push(a),i.type===V.comma&&i.raise(i.start,"Comma is not permitted after the rest element"),i.expect(t)
break}var o=i.parseMaybeDefault(i.start,i.startLoc)
i.parseBindingListItem(o),r.push(o)}return r},st.parseBindingListItem=function(t){return t},st.parseMaybeDefault=function(t,e,s){if(s=s||this.parseBindingAtom(),this.options.ecmaVersion<6||!this.eat(V.eq))return s
...
if(this.type===V.comma){var a=this.startNodeAt(i,r)
for(a.expressions=[n];this.eat(V.comma);)a.expressions.push(s.parseMaybeAssign(t,e))
...
if(null!=n&&(!r||this.type!==V._in)&&n>i){var a=this.type===V.logicalOR||this.type===V.logicalAND,o=this.value
this.next()
...
else if(this.type.prefix){var a=this.startNode(),o=this.type===V.incDec
...
h.operator=i.value,h.prefix=!1,h.argument=s,i.checkLVal(s),i.next(),s=i.finishNode(h,"UpdateExpression")}}return!e&&this.eat(V.starstar)?this.buildBinary(r,n,s,this.parseMaybeUnary(null,!1),"**",!1):s},it.parseExprSubscripts=function(t){var e=this.start,s=this.startLoc,i=this.parseExprAtom(t),r="ArrowFunctionExpression"===i.type&&")"!==this.input.slice(this.lastTokStart,this.lastTokEnd)
if(this.checkExpressionErrors(t)||r)return i
var n=this.parseSubscripts(i,e,s)
return t&&"MemberExpression"===n.type&&(t.parenthesizedAssign>=n.start&&(t.parenthesizedAssign=-1),t.parenthesizedBind>=n.start&&(t.parenthesizedBind=-1)),n},it.parseSubscripts=function(t,e,s,i){for(var r=this,n=this.options.ecmaVersion>=8&&"Identifier"===t.type&&"async"===t.name&&this.lastTokEnd==t.end&&!this.canInsertSemicolon()&&"async"===this.input.slice(t.start,t.end),a=void 0;;)if((a=r.eat(V.bracketL))||r.eat(V.dot)){var o=r.startNodeAt(e,s)
o.object=t,o.property=a?r.parseExpression():r.parseIdent(!0),o.computed=!!a,a&&r.expect(V.bracketR),t=r.finishNode(o,"MemberExpression")}else if(!i&&r.eat(V.parenL)){var h=new f,p=r.yieldPos,c=r.awaitPos
r.yieldPos=0,r.awaitPos=0
var u=r.parseExprList(V.parenR,r.options.ecmaVersion>=8,!1,h)
if(n&&!r.canInsertSemicolon()&&r.eat(V.arrow))return r.checkPatternErrors(h,!1),r.checkYieldAwaitInDefaultParams(),r.yieldPos=p,r.awaitPos=c,r.parseArrowExpression(r.startNodeAt(e,s),u,!0)
r.checkExpressionErrors(h,!0),r.yieldPos=p||r.yieldPos,r.awaitPos=c||r.awaitPos
var l=r.startNodeAt(e,s)
l.callee=t,l.arguments=u,t=r.finishNode(l,"CallExpression")}else{if(r.type!==V.backQuote)return t
...
switch(this.type){case V._super:return this.inFunction||this.raise(this.start,"'super' outside of function or class"),e=this.startNode(),this.next(),this.type!==V.dot&&this.type!==V.bracketL&&this.type!==V.parenL&&this.unexpected(),this.finishNode(e,"Super")
case V._this:return e=this.startNode(),this.next(),this.finishNode(e,"ThisExpression")
case V.name:var i=this.start,r=this.startLoc,n=this.containsEsc,a=this.parseIdent(this.type!==V.name)
if(this.options.ecmaVersion>=8&&!n&&"async"===a.name&&!this.canInsertSemicolon()&&this.eat(V._function))return this.parseFunction(this.startNodeAt(i,r),!1,!1,!0)
if(s&&!this.canInsertSemicolon()){if(this.eat(V.arrow))return this.parseArrowExpression(this.startNodeAt(i,r),[a],!1)
if(this.options.ecmaVersion>=8&&"async"===a.name&&this.type===V.name&&!n)return a=this.parseIdent(),!this.canInsertSemicolon()&&this.eat(V.arrow)||this.unexpected(),this.parseArrowExpression(this.startNodeAt(i,r),[a],!0)}return a
case V.regexp:var o=this.value
return e=this.parseLiteral(o.value),e.regex={pattern:o.pattern,flags:o.flags},e
case V.num:case V.string:return this.parseLiteral(this.value)
case V._null:case V._true:case V._false:return e=this.startNode(),e.value=this.type===V._null?null:this.type===V._true,e.raw=this.type.keyword,this.next(),this.finishNode(e,"Literal")
case V.parenL:var h=this.start,p=this.parseParenAndDistinguishExpression(s)
...
case V.bracketL:return e=this.startNode(),this.next(),e.elements=this.parseExprList(V.bracketR,!0,!0,t),this.finishNode(e,"ArrayExpression")
case V.braceL:return this.parseObj(!1,t)
case V._function:return e=this.startNode(),this.next(),this.parseFunction(e,!1)
case V._class:return this.parseClass(this.startNode(),!1)
...
return e.value=t,e.raw=this.input.slice(this.start,this.end),this.next(),this.finishNode(e,"Literal")},it.parseParenExpression=function(){this.expect(V.parenL)
var t=this.parseExpression()
return this.expect(V.parenR),t},it.parseParenAndDistinguishExpression=function(t){var e,s=this,i=this.start,r=this.startLoc,n=this.options.ecmaVersion>=8
...
for(this.yieldPos=0,this.awaitPos=0;this.type!==V.parenR;){if(c?c=!1:s.expect(V.comma),n&&s.afterTrailingComma(V.parenR,!0)){u=!0
break}if(s.type===V.ellipsis){a=s.start,p.push(s.parseParenItem(s.parseRestBinding())),s.type===V.comma&&s.raise(s.start,"Comma is not permitted after the rest element")
break}p.push(s.parseMaybeAssign(!1,l,s.parseParenItem))}var x=this.start,y=this.startLoc
if(this.expect(V.parenR),t&&!this.canInsertSemicolon()&&this.eat(V.arrow))return this.checkPatternErrors(l,!1),this.checkYieldAwaitInDefaultParams(),this.yieldPos=d,this.awaitPos=m,this.parseParenArrowList(i,r,p)
...
if(this.options.ecmaVersion>=6&&this.eat(V.dot)){t.meta=e
...
return t.callee=this.parseSubscripts(this.parseExprAtom(),i,r,!0),this.eat(V.parenL)?t.arguments=this.parseExprList(V.parenR,this.options.ecmaVersion>=8,!1):t.arguments=rt,this.finishNode(t,"NewExpression")},it.parseTemplateElement=function(t){var e=t.isTagged,s=this.startNode()
return this.type===V.invalidTemplate?(e||this.raiseRecoverable(this.start,"Bad escape sequence in untagged template literal"),s.value={raw:this.value,cooked:null}):s.value={raw:this.input.slice(this.start,this.end).replace(/\r\n?/g,"\n"),cooked:this.value},this.next(),s.tail=this.type===V.backQuote,this.finishNode(s,"TemplateElement")},it.parseTemplate=function(t){var e=this
void 0===t&&(t={})
var s=t.isTagged
void 0===s&&(s=!1)
...
for(i.quasis=[r];!r.tail;)e.expect(V.dollarBraceL),i.expressions.push(e.parseExpression()),e.expect(V.braceR),i.quasis.push(r=e.parseTemplateElement({isTagged:s}))
return this.next(),this.finishNode(i,"TemplateLiteral")},it.isAsyncProp=function(t){return!t.computed&&"Identifier"===t.key.type&&"async"===t.key.name&&(this.type===V.name||this.type===V.num||this.type===V.string||this.type===V.bracketL||this.type.keyword)&&!F.test(this.input.slice(this.lastTokEnd,this.start))},it.parseObj=function(t,e){var s=this,i=this.startNode(),r=!0,n={}
for(i.properties=[],this.next();!this.eat(V.braceR);){if(r)r=!1
else if(s.expect(V.comma),s.afterTrailingComma(V.braceR))break
...
this.options.ecmaVersion>=6&&(a.method=!1,a.shorthand=!1,(t||e)&&(r=this.start,n=this.startLoc),t||(s=this.eat(V.star)))
var o=this.containsEsc
return this.parsePropertyName(a),!t&&!o&&this.options.ecmaVersion>=8&&!s&&this.isAsyncProp(a)?(i=!0,this.parsePropertyName(a,e)):i=!1,this.parsePropertyValue(a,t,s,i,r,n,e,o),this.finishNode(a,"Property")},it.parsePropertyValue=function(t,e,s,i,r,n,a,o){if((s||i)&&this.type===V.colon&&this.unexpected(),this.eat(V.colon))t.value=e?this.parseMaybeDefault(this.start,this.startLoc):this.parseMaybeAssign(!1,a),t.kind="init"
else if(this.options.ecmaVersion>=6&&this.type===V.parenL)e&&this.unexpected(),t.kind="init",t.method=!0,t.value=this.parseMethod(s,i)
...
else if(r.expect(V.comma),e&&r.afterTrailingComma(t))break
var o=void 0
s&&r.type===V.comma?o=null:r.type===V.ellipsis?(o=r.parseSpread(i),i&&r.type===V.comma&&i.trailingComma<0&&(i.trailingComma=r.start)):o=r.parseMaybeAssign(!1,i),n.push(o)}return n},it.checkUnreserved=function(t){var e=t.start,s=t.end,i=t.name
...
return t&&"never"==this.options.allowReserved&&(t=!1),this.type===V.name?s.name=this.value:this.type.keyword?(s.name=this.type.keyword,"class"!==s.name&&"function"!==s.name||this.lastTokEnd===this.lastTokStart+1&&46===this.input.charCodeAt(this.lastTokStart)||this.context.pop()):this.unexpected(),this.next(),this.finishNode(s,"Identifier"),t||this.checkUnreserved(s),s},it.parseYield=function(){this.yieldPos||(this.yieldPos=this.start)
var t=this.startNode()
return this.next(),this.type==V.semi||this.canInsertSemicolon()||this.type!=V.star&&!this.type.startsExpr?(t.delegate=!1,t.argument=null):(t.delegate=this.eat(V.star),t.argument=this.parseMaybeAssign()),this.finishNode(t,"YieldExpression")},it.parseAwait=function(){this.awaitPos||(this.awaitPos=this.start)
var t=this.startNode()
...
return e===ut.f_expr||e===ut.f_stat||(t!==V.colon||e!==ut.b_stat&&e!==ut.b_expr?t===V._return||t==V.name&&this.exprAllowed?F.test(this.input.slice(this.lastTokEnd,this.start)):t===V._else||t===V.semi||t===V.eof||t===V.parenR||t==V.arrow||(t==V.braceL?e===ut.b_stat:t!=V._var&&t!=V.name&&!this.exprAllowed):!e.isExpr)},lt.inGeneratorContext=function(){for(var t=this,e=this.context.length-1;e>=1;e--){var s=t.context[e]
if("function"===s.token)return s.generator}return!1},lt.updateContext=function(t){var e,s=this.type
s.keyword&&t==V.dot?this.exprAllowed=!1:(e=s.updateContext)?e.call(this,t):this.exprAllowed=s.beforeExpr},V.parenR.updateContext=V.braceR.updateContext=function(){if(1==this.context.length)return void(this.exprAllowed=!0)
var t=this.context.pop()
t===ut.b_stat&&"function"===this.curContext().token&&(t=this.context.pop()),this.exprAllowed=!t.isExpr},V.braceL.updateContext=function(t){this.context.push(this.braceIsBlock(t)?ut.b_stat:ut.b_expr),this.exprAllowed=!0},V.dollarBraceL.updateContext=function(){this.context.push(ut.b_tmpl),this.exprAllowed=!0},V.parenL.updateContext=function(t){var e=t===V._if||t===V._for||t===V._with||t===V._while
this.context.push(e?ut.p_stat:ut.p_expr),this.exprAllowed=!0},V.incDec.updateContext=function(){},V._function.updateContext=V._class.updateContext=function(t){t.beforeExpr&&t!==V.semi&&t!==V._else&&(t!==V.colon&&t!==V.braceL||this.curContext()!==ut.b_stat)?this.context.push(ut.f_expr):this.context.push(ut.f_stat),this.exprAllowed=!1},V.backQuote.updateContext=function(){this.curContext()===ut.q_tmpl?this.context.pop():this.context.push(ut.q_tmpl),this.exprAllowed=!1},V.star.updateContext=function(t){if(t==V._function){var e=this.context.length-1
this.context[e]===ut.f_expr?this.context[e]=ut.f_expr_gen:this.context[e]=ut.f_gen}this.exprAllowed=!0},V.name.updateContext=function(t){var e=!1
...
return{done:e.type===V.eof,value:e}}}}),ft.curContext=function(){return this.context[this.context.length-1]},ft.nextToken=function(){var t=this.curContext()
return t&&t.preserveSpace||this.skipSpace(),this.start=this.pos,this.options.locations&&(this.startLoc=this.curPosition()),this.pos>=this.input.length?this.finishToken(V.eof):t.override?t.override(this):void this.readToken(this.fullCharCodeAtPos())},ft.readToken=function(t){return r(t,this.options.ecmaVersion>=6)||92===t?this.readWord():this.getTokenFromCode(t)},ft.fullCharCodeAtPos=function(){var t=this.input.charCodeAt(this.pos)
...
return this.options.ecmaVersion>=6&&46===t&&46===e?(this.pos+=3,this.finishToken(V.ellipsis)):(++this.pos,this.finishToken(V.dot))},ft.readToken_slash=function(){var t=this.input.charCodeAt(this.pos+1)
return this.exprAllowed?(++this.pos,this.readRegexp()):61===t?this.finishOp(V.assign,2):this.finishOp(V.slash,1)},ft.readToken_mult_modulo_exp=function(t){var e=this.input.charCodeAt(this.pos+1),s=1,i=42===t?V.star:V.modulo
return this.options.ecmaVersion>=7&&42==t&&42===e&&(++s,i=V.starstar,e=this.input.charCodeAt(this.pos+2)),61===e?this.finishOp(V.assign,s+1):this.finishOp(i,s)},ft.readToken_pipe_amp=function(t){var e=this.input.charCodeAt(this.pos+1)
return e===t?this.finishOp(124===t?V.logicalOR:V.logicalAND,2):61===e?this.finishOp(V.assign,2):this.finishOp(124===t?V.bitwiseOR:V.bitwiseAND,1)},ft.readToken_caret=function(){return 61===this.input.charCodeAt(this.pos+1)?this.finishOp(V.assign,2):this.finishOp(V.bitwiseXOR,1)},ft.readToken_plus_min=function(t){var e=this.input.charCodeAt(this.pos+1)
return e===t?45!=e||this.inModule||62!=this.input.charCodeAt(this.pos+2)||0!==this.lastTokEnd&&!F.test(this.input.slice(this.lastTokEnd,this.pos))?this.finishOp(V.incDec,2):(this.skipLineComment(3),this.skipSpace(),this.nextToken()):61===e?this.finishOp(V.assign,2):this.finishOp(V.plusMin,1)},ft.readToken_lt_gt=function(t){var e=this.input.charCodeAt(this.pos+1),s=1
...
return 61===e?this.finishOp(V.equality,61===this.input.charCodeAt(this.pos+2)?3:2):61===t&&62===e&&this.options.ecmaVersion>=6?(this.pos+=2,this.finishToken(V.arrow)):this.finishOp(61===t?V.eq:V.prefix,1)},ft.getTokenFromCode=function(t){switch(t){case 46:return this.readToken_dot()
case 40:return++this.pos,this.finishToken(V.parenL)
case 41:return++this.pos,this.finishToken(V.parenR)
case 59:return++this.pos,this.finishToken(V.semi)
case 44:return++this.pos,this.finishToken(V.comma)
case 91:return++this.pos,this.finishToken(V.bracketL)
case 93:return++this.pos,this.finishToken(V.bracketR)
case 123:return++this.pos,this.finishToken(V.braceL)
case 125:return++this.pos,this.finishToken(V.braceR)
case 58:return++this.pos,this.finishToken(V.colon)
case 63:return++this.pos,this.finishToken(V.question)
...
case 126:return this.finishOp(V.prefix,1)}this.raise(this.pos,"Unexpected character '"+y(t)+"'")},ft.finishOp=function(t,e){var s=this.input.slice(this.pos,this.pos+e)
...
return mt||(x(o,h,i,this),c=x(n,a)),this.finishToken(V.regexp,{pattern:n,flags:a,value:c})},ft.readInt=function(t,e){for(var s=this,i=this.pos,r=0,n=0,a=null==e?1/0:e;n<a;++n){var o=s.input.charCodeAt(s.pos),h=void 0
...
return null==e&&this.raise(this.start+2,"Expected number in radix "+t),r(this.fullCharCodeAtPos())&&this.raise(this.pos,"Identifier directly after number"),this.finishToken(V.num,e)},ft.readNumber=function(t){var e=this.pos
...
return this.finishToken(V.num,a)},ft.readCodePoint=function(){var t,e=this.input.charCodeAt(this.pos)
...
if(r===t)break
92===r?(s+=e.input.slice(i,e.pos),s+=e.readEscapedChar(!1),i=e.pos):(h(r)&&e.raise(e.start,"Unterminated string constant"),++e.pos)}return s+=this.input.slice(i,this.pos++),this.finishToken(V.string,s)}
var yt={}
...
if(96===i||36===i&&123===t.input.charCodeAt(t.pos+1))return t.pos!==t.start||t.type!==V.template&&t.type!==V.invalidTemplate?(e+=t.input.slice(s,t.pos),t.finishToken(V.template,e)):36===i?(t.pos+=2,t.finishToken(V.dollarBraceL)):(++t.pos,t.finishToken(V.backQuote))
...
case"`":return t.finishToken(V.invalidTemplate,t.input.slice(t.start,t.pos))}this.raise(this.start,"Unterminated template")},ft.readEscapedChar=function(t){var e=this.input.charCodeAt(++this.pos)
...
var p=t.readCodePoint();(s?r:n)(p,a)||t.invalidStringToken(h,"Invalid Unicode escape"),e+=y(p),i=t.pos}s=!1}return e+this.input.slice(i,this.pos)},ft.readWord=function(){var t=this.readWord1(),e=V.name
return this.keywords.test(t)&&(this.containsEsc&&this.raiseRecoverable(this.start,"Escape sequence in keyword "+t),e=O[t]),this.finishToken(e,t)}
