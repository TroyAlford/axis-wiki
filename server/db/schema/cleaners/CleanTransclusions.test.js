...
describe('CleanTransclusions', () => {
  it('strips tag contents', () => {
    ...
    const expected = '<include from="test" sections="*"/>'
  ...
  it('enforces slug-format for from attribute', () => {
    ...
    const expected = '<include from="test-slug" sections="*"/>'
  ...
  it('enforces slug-format for specified sections', () => {
    const before = '<include from="test" sections="A Slug, Another Slug, Third"/>'
    const expected = '<include from="test" sections="a-slug,another-slug,third"/>'
  ...
  it('eliminates * and invalid slugs from lists with multiple sections', () => {
    ...
    const expected = '<include from="test" sections="a-slug"/>'
